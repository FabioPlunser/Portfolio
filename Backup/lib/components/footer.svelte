<footer class="footer p-10 bg-base-200 text-base-content bottom-0 mt-96 bg-neutral">
	<div>
...
<footer class="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300 bg-neutral">
